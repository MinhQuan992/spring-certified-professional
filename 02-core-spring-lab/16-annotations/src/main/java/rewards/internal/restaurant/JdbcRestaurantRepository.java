...
public class JdbcRestaurantRepository implements RestaurantRepository {
	...
	// There are 2 constructors. If this constructor is not annotated with @Autowired,
	// the no-args constructor will be called by Spring, so the cache won't be initialized.
	...
	// A better approach to construct the cache
	@PostConstruct
