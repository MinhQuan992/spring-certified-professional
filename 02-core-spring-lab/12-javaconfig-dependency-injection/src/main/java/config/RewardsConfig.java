...
@Configuration
// Tells Spring to treat this class as a set of configuration instructions
// to be used when the application is starting up.
public class RewardsConfig {
	...
	// Each bean method should return an interface not a concrete class.

	// A bean’s name should describe the service it provides.
